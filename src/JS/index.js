...
const opcoesDeTamanho = ["41mm", "45mm"];
...
function trocarTamanho() {
  //atualizar variável de contorle de tamanho da caixa
  const idOpcaoSelecionada = document.querySelector(
  ...
  tituloProduto.innerText =
    ...
    " para caixa de " +
    opcoesDeTamanho[tamanhoSelecionado];
  //mudar o tamanho da imagem de acordo com a opção
  if (opcoesDeTamanho[tamanhoSelecionado] === "41mm") {
...
function trocarCor() {
  ...
  //trocar imagens das miniaturas de seleção
